(ns fulcro.inspect.card-helpers
  ...
  #?(:cljs (:require-macros [fulcro.inspect.card-helpers :refer [load-locale]])))
   ...
   (defn make-root [Root app-id]
     (fp/ui
      ...
      (initial-state [_ params] {:fulcro.inspect.core/app-id app-id
                                 ::i18n/current-locale       (fp/get-initial-state i18n/Locale (load-locale :en "English"))
                                 ::i18n/locale-by-id         [(fp/get-initial-state i18n/Locale (load-locale :en "English"))
                                                              (fp/get-initial-state i18n/Locale (load-locale :pt "Portugues"))
                                                              (fp/get-initial-state i18n/Locale (load-locale :nl "Dutch"))]
