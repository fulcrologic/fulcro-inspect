...
(defn app-id [app]
  (or (some-> (app/current-state app) :fulcro.inspect.core/app-id)
    (some-> (app/app-root app) ui.h/react-display-name)))
...
(defn handle-devtool-message [{:keys [type data]}]
  (case type
    ...
    (post-message :fulcro.inspect.client/client-version {:version version/last-inspect-version})
