(ns fulcro.inspect.workspaces.ui.network-cards
  (:require
...
(ws/defcard network-card
  {::wsm/align {:flex "1"}}
  (ct.fulcro/fulcro-card
    {::f.portal/root       NetworkRoot
...
(ws/defcard network-sampler
  (ct.fulcro/fulcro-card
    {::f.portal/root NameLoaderRoot
     ::f.portal/app  {:networking (pfn/pathom-remote parser)}}))

(ws/defcard network-sampler-remote-i
  (ct.fulcro/fulcro-card
    {::f.portal/root NameLoaderRoot
